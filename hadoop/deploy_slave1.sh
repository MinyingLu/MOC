...
bigtop::hadoop_head_node: hadoop-master.csail.mit.edu
...
echo "$IP_ADDR  ${HOSTNAME}.csail.mit.edu " >> /etc/hosts
echo "128.52.181.249  hadoop-master.csail.mit.edu" >> /etc/hosts
