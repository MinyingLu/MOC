...
class ServerActionsTestJSON(base.BaseV2ComputeTest):
    ...
    def test_rebuild_server(self):
        ...
        # NOTE(minying):
        # Instance fail to rebuild and goes to 'ERROR' state 
        # when pass in personality parameter 
        # error message: "[Errno 2] No such file or directory: 
        # 'rbd:volumes/server_id_disk:id=cinder:conf=/etc/ceph/ceph.conf'"
    ...
    def test_create_backup(self):
        ...
        # NOTE(minying): originally wait for image status 'active'
        # But the backup image fail/takes forever to reach 'active' 
        # It CAN reach 'active' if set to wait for 'saving' 
        # or disable the line
        self.os.image_client.wait_for_image_status(image1_id, 'saving')
