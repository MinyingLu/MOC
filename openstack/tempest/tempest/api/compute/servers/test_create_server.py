...
class ServersTestJSON(base.BaseV2ComputeTest):
    ...
    def resource_setup(cls):
        ...
        # NOTE(minying): originally wait for 'ACTIVE' change to 'BUILD'
        # otherwise the server will stuck in 'BUILD' or 'ERROR' status
        # and throw exceede max scheduling attempts error 
        # Works when wait for 'BUILD' (i.e. test server reaches 'ACTIVE')
        cls.client.wait_for_server_status(cls.server_initial['id'], 'BUILD')
